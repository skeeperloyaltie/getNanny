...
if ( ! class_exists( 'Fashion_Designer_Mart_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Fashion_Designer_Mart_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Fashion_Designer_Mart_WPTT_WebFont_Loader( $url );
